        ...
        <header className="absolute top-0 left-0 right-0 z-50 pt-4 px-4">
          <nav className="container mx-auto max-w-7xl">
            <div className="relative rounded-2xl p-[3px] bg-gradient-to-r from-primary-blue via-purple-500 via-pink-500 via-red-500 to-warm-orange shadow-2xl">
              <div className="relative bg-black/60 backdrop-blur-2xl backdrop-saturate-150 rounded-2xl px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative rounded-3xl p-[3px] bg-gradient-to-r from-primary-blue via-purple-500 via-pink-500 via-red-500 to-warm-orange shadow-2xl">
              <div className="relative bg-black/60 backdrop-blur-2xl backdrop-saturate-150 rounded-3xl p-8 sm:p-10 lg:p-12">
            ...
            <div className="relative hidden lg:block">
              <div className="relative w-full aspect-square max-w-md mx-auto">
                ...
                <div className="relative rounded-3xl p-[3px] bg-gradient-to-r from-primary-blue via-purple-500 via-pink-500 via-red-500 to-warm-orange shadow-2xl">
                  <div className="relative bg-black/60 backdrop-blur-2xl backdrop-saturate-150 rounded-3xl p-8 flex items-center justify-center">
                    <Image
                      src="/logo.png"
                      alt="Nicole Hinrich"
                      width={400}
