...
export default function AnimatedTextarea({ label, id, ...props }: AnimatedTextareaProps) {
  ...
  return (
    <div className="relative">
      <motion.textarea
        ...
        className={`w-full px-4 py-3 rounded-lg border-2 outline-none transition-all duration-300 resize-none ${
          isFocused
